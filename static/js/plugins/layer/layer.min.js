...
! function(a, b) {
	...
	var c, d, e = {
		...
		f = {
			...
			config: function(a, b) {
				var d = 0;
				return a = a || {}, f.cache = e.config = c.extend(e.config, a), f.path = e.config.path || f.path, "string" == typeof a.extend && (a.extend = [a.extend]), f.use("layer/skin/default/layer.css", a.extend && a.extend.length > 0 ? function g() {
					var c = a.extend;
	...
	h.anim = ["layui-anim", "layui-anim-01", "layui-anim-02", "layui-anim-03", "layui-anim-04", "layui-anim-05", "layui-anim-06"], g.pt.config = {
		...
		a.layer = f, e.run(), f.use("layer/skin/default/layer.css")
	}()
}(window);