...
function SmoothlyMenu() {
	$("body").hasClass("mini-navbar") ? $("body").hasClass("fixed-sidebar") ? ($("#side-menu").hide(), setTimeout(function() {
		...
		/*$('.fixed-sidebar.mini-navbar .nav li').mouseover(function(){
			$('.fixed-sidebar.mini-navbar .nav li>.nav-second-level').show();
		});
		$('.fixed-sidebar.mini-navbar .nav li').mouseout(function(){
			$(this).children('.nav-second-level').hide();
		});*/
...
layer.config({
	...
	$("#side-menu").metisMenu(), $(".right-sidebar-toggle").click(function() {
		...
		/*$('.body.canvas-menu .navbar-static-side, body.fixed-sidebar .navbar-static-side').css('width');*/
